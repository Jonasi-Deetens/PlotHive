            ...
            {booksList && booksList.slice(0,4).map((book) => (
                <div className="profile-book" key={'BOOK_KEY_' + book._id}> 
                    <div className='top-wrapper'>
                        <div>
                            <img className="profile-book-image" src={cover} width={120} height={190} alt="Placeholder of an image of a book" />
                        </div>
                        <div className='button-wrapper'>
                            <Link className='link' to={"/read?id=" + book._id}>read</Link>
                            <Link className='link' to={"/write?id=" + book._id}>write</Link>
                        </div>
                    </div>
